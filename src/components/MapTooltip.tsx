...
const MapTooltip = () => {
    return (
        <div className="map-tooltip-wrapper relative group inline-block">
            <style>
                {`
        .map-tooltip-card {
          position: absolute;
          ...
          overflow: hidden;
          z-index: 50;
          transition: all 0.3s cubic-bezier(0.74, -0.03, 0.05, 1.24);
          opacity: 0;
          pointer-events: none;
        }

        /* Show card on hover of the text wrapper */
        .map-tooltip-wrapper:hover .map-tooltip-card {
        ...
        `}
            ...
            {/* Trigger Text */}
            <div className="cursor-help border-b border-dotted border-brand-accent inline-block">
                ...
                <div className="map-tooltip-inner-card">
                    ...
                    <div className="map-tooltip-elements">
                        <div className="map-tooltip-description">
                            ...
                            <span className="map-tooltip-card-title">São Paulo</span>
                            <p className="map-tooltip-second-title">Brasil</p>
                        </div>
